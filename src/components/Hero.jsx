  ...
  return (
    <div className="min-h-px lg:min-h-screen flex items-center md:items-start justify-center py-4 lg:py-4 md:p-6">
      <div className="text-center max-w-3xl px-4 sm:px-6 lg:px-8 md:space-y-2">
        ...
        <a href="#proposta" className="inline-flex items-center mt-8 md:mt-2 px-6 py-3 bg-gradient-to-r from-indigo-900 to-blue-600 text-white font-medium rounded-lg hover:from-indigo-800 hover:to-blue-500 transition-all duration-300 shadow-lg">
